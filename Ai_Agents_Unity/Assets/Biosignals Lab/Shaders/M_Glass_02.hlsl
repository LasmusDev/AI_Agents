...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.387500,0.387500,0.387500,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.387500,0.387500,0.387500,10.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.000000,0.200000,10.000000,1.400000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local6 = PositiveClampedPow(Local5,Material.PreshaderBuffer[4].z);
	MaterialFloat Local7 = (Local6 * (1.00000000 - 0.00000000));
	MaterialFloat Local8 = (Local7 + 0.00000000);
	MaterialFloat Local9 = lerp(1.00000000,Material.PreshaderBuffer[4].w,Local8);

	PixelMaterialInputs.EmissiveColor = Local0;
	PixelMaterialInputs.Opacity = Material.PreshaderBuffer[4].y;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Material.PreshaderBuffer[3].xyz;
	PixelMaterialInputs.Metallic = 0.30000001;
	...
	PixelMaterialInputs.Refraction = MaterialFloat2(Local9,Material.PreshaderBuffer[5].x);
