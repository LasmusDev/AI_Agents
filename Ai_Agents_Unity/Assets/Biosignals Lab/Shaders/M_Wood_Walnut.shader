Shader "Unreal/M_Wood_Walnut"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Wood_Walnut_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MacroVariation", 2D ) = "white" {}
		Material_Texture2D_2( "T_Wood_Walnut_D", 2D ) = "white" {}
