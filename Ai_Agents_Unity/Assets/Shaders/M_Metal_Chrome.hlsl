...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local2 = (DERIV_BASE_VALUE(Local1) * ((MaterialFloat2)0.21340001));
	MaterialFloat Local3 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local2), 0);
	MaterialFloat4 Local4 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_0,samplerMaterial_Texture2D_0,DERIV_BASE_VALUE(Local2),View.MaterialTextureMipBias));
	MaterialFloat Local5 = MaterialStoreTexSample(Parameters, Local4, 0);
	MaterialFloat Local6 = (Local4.r + 0.50000000);
	MaterialFloat2 Local7 = (DERIV_BASE_VALUE(Local1) * ((MaterialFloat2)0.05341000));
	MaterialFloat Local8 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local7), 0);
	MaterialFloat4 Local9 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_0,samplerMaterial_Texture2D_0,DERIV_BASE_VALUE(Local7),View.MaterialTextureMipBias));
	MaterialFloat Local10 = MaterialStoreTexSample(Parameters, Local9, 0);
	MaterialFloat Local11 = (Local9.r + 0.50000000);
	MaterialFloat2 Local12 = (DERIV_BASE_VALUE(Local1) * ((MaterialFloat2)0.00200000));
	MaterialFloat Local13 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local12), 0);
	MaterialFloat4 Local14 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_0,samplerMaterial_Texture2D_0,DERIV_BASE_VALUE(Local12),View.MaterialTextureMipBias));
	MaterialFloat Local15 = MaterialStoreTexSample(Parameters, Local14, 0);
	MaterialFloat Local16 = (Local14.r + 0.50000000);
	MaterialFloat Local17 = (Local11 * Local16);
	MaterialFloat Local18 = (Local6 * Local17);
	MaterialFloat Local19 = lerp(1.00000000,0.89999998,Local18);
	...
	PixelMaterialInputs.Roughness = 0.25000000;
