...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.222222,1.396262,0.000000,3.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local1 = RotateAboutAxis(MaterialFloat4(MaterialFloat3(0.00000000,0.00000000,1.00000000),Material.PreshaderBuffer[1].y),LWCPromote(((MaterialFloat3)Material.PreshaderBuffer[1].z)),DERIV_BASE_VALUE(Local0));
	FLWCVector3 Local2 = LWCAdd(LWCPromote(Local1), DERIV_BASE_VALUE(Local0));
	MaterialFloat3 Local3 = LWCNormalize(Local2);
	MaterialFloat Local4 = MaterialStoreTexCoordScale(Parameters, Local3, 0);
	MaterialFloat4 Local5 = ProcessMaterialLinearColorTextureLookup(TextureCubeSample(Material_TextureCube_0,samplerMaterial_TextureCube_0,Local3));
	MaterialFloat Local6 = MaterialStoreTexSample(Parameters, Local5, 0);
	MaterialFloat3 Local7 = (Local5.rgb * ((MaterialFloat3)Material.PreshaderBuffer[1].w));
	MaterialFloat3 Local8 = lerp(Local7,Material.PreshaderBuffer[2].yzw,Material.PreshaderBuffer[2].x);
