...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local5 = (DERIV_BASE_VALUE(Local0) * ((MaterialFloat2)0.21340001));
	MaterialFloat Local6 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local5), 2);
	MaterialFloat4 Local7 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,samplerMaterial_Texture2D_1,DERIV_BASE_VALUE(Local5),View.MaterialTextureMipBias));
	MaterialFloat Local8 = MaterialStoreTexSample(Parameters, Local7, 2);
	MaterialFloat Local9 = (Local7.r + 0.50000000);
	MaterialFloat2 Local10 = (DERIV_BASE_VALUE(Local0) * ((MaterialFloat2)0.05341000));
	MaterialFloat Local11 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local10), 2);
	MaterialFloat4 Local12 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,samplerMaterial_Texture2D_1,DERIV_BASE_VALUE(Local10),View.MaterialTextureMipBias));
	MaterialFloat Local13 = MaterialStoreTexSample(Parameters, Local12, 2);
	MaterialFloat Local14 = (Local12.r + 0.50000000);
	MaterialFloat2 Local15 = (DERIV_BASE_VALUE(Local0) * ((MaterialFloat2)0.00200000));
	MaterialFloat Local16 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local15), 2);
	MaterialFloat4 Local17 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,samplerMaterial_Texture2D_1,DERIV_BASE_VALUE(Local15),View.MaterialTextureMipBias));
	MaterialFloat Local18 = MaterialStoreTexSample(Parameters, Local17, 2);
	MaterialFloat Local19 = (Local17.r + 0.50000000);
	MaterialFloat Local20 = (Local14 * Local19);
	MaterialFloat Local21 = (Local9 * Local20);
	MaterialFloat3 Local22 = lerp(MaterialFloat3(0.80000001,0.80000001,0.80000001),((MaterialFloat3)1.00000000),Local21);
	MaterialFloat Local23 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local24 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local25 = MaterialStoreTexSample(Parameters, Local24, 0);
	MaterialFloat3 Local26 = (Local22 * Local24.rgb);
	MaterialFloat Local27 = (Local21 * Local24.a);
	MaterialFloat Local28 = lerp(0.80000001,0.50000000,Local27);
